<section class="w-full">
    ...
    <x-settings.layout :heading="__('Perfil')" :subheading="__('Actualiza tu nombre, usuario y correo electrónico')">
        <form wire:submit="updateProfileInformation" class="my-6 w-full space-y-6">
            <flux:input wire:model="name" :label="__('Nombre')" type="text" required autofocus autocomplete="name" />

            <flux:input wire:model="username" :label="__('Usuario')" type="text" required autocomplete="username" />
