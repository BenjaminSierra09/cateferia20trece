<div class="space-y-6">
    <div class="flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <flux:button :href="route('dashboard.customizations.options.create')" variant="primary" icon="plus" wire:navigate>Nueva opción</flux:button>
        </div>
    </div>
    ...
    <div class="grid gap-4 lg:grid-cols-[260px_minmax(0,1fr)]">
        <flux:card class="space-y-3">
            ...
            <div class="grid gap-2">
                <flux:button :href="route('dashboard.customizations.types.index')" variant="ghost" class="justify-start" wire:navigate icon="squares-2x2">Tipos</flux:button>
                <flux:button :href="route('dashboard.customizations.options.index')" variant="primary" class="justify-start" wire:navigate icon="sparkles">Opciones</flux:button>
            </div>
        </flux:card>
                            ...
                            <flux:table.cell>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-zinc-500">Se suma al precio final cuando aplica.</div>
                                    </div>
                                </div>
                            </flux:table.cell>
